...
1. Read `docs/PROJECT.md` (the brief — design must serve it), plus `docs/ARCHITECTURE.md`, `docs/SPEC.md`, `AGENTS.md`, `docs/MEMORY.md`. Summarize current state in 1–2 lines. Re-entrant: refine, don't restart.
...
Pull in the relevant skill rather than improvising, for example:
- Find documentation for research purposes → `find-docs`.
...
Note any `TODO` in ARCHITECTURE.md / SPEC.md, then: `Suggested next: /plan — or /document to refresh README/ARCHITECTURE prose.`
